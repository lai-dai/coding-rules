...
export function TableToolbar<T extends RowData>({
  filters, onFiltersChange, table, onFilterClick, onExportClick, OtherComponent, FiltersComponent, hasFilters = true, hasReset = true, hasExport = false, exportText = "Xuất Excel",
}: TableToolbarProps & {
  table?: Table<T>
}) {
      ...
      <div className="flex gap-3 items-center justify-end">
...

        {
          hasExport
            ? (
              <Button
                className="bg-success/90 hover:bg-success"
                size="sm"
